...
def compute_reward(cfg, ate_fruit: bool, died: bool,
                   dist_before: int, dist_after: int) -> float:
    ...
    2) Frucht gefressen: volle +10 (plus die winzige Zeitstrafe). Hier gibt es
    ...
    3) Normaler Zug: Zeitstrafe + Naeher/Weiter-Hinweis.
    """
    if died:
    ...
    if ate_fruit:
        return reward + cfg.reward_fruit

    if dist_after < dist_before:
        reward += cfg.reward_closer
    elif dist_after > dist_before:
        reward += cfg.reward_farther
